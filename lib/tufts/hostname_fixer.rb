...
module Tufts
  ...
  class HostnameFixer
    ...
    def self.fix_all_tdl_resources
      @solr_map = {}
      Tufts::TdlResource.find_each { |r| fix_tdl_resource(r) }
      save_solr_map
    end
    ...
    private_class_method :fix_item, :save_solr_map, :load_solr_map, :solr_map_file,
                         :no_items?, :ignore_blocks, :old_host, :new_host, :other_host
  end
end
