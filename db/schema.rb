...
ActiveRecord::Schema.define(version: 20171201124773) do
  ...
  create_table "spotlight_attachments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.string   "file"
    t.string   "uid"
  ...
  create_table "spotlight_blacklight_configurations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "exhibit_id"
  ...
  create_table "spotlight_contact_emails", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "exhibit_id"
  ...
  create_table "spotlight_contacts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "slug"
    t.string   "name"
    t.string   "email"
    t.string   "title"
  ...
  create_table "spotlight_custom_fields", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "exhibit_id"
    t.string   "slug"
    t.string   "field"
  ...
  create_table "spotlight_exhibits", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spotlight_featured_images", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "type"
    t.boolean  "display"
    t.string   "image"
    t.string   "source"
  ...
  create_table "spotlight_filters", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "field"
    t.string   "value"
    t.integer  "exhibit_id"
    t.datetime "created_at", null: false
  ...
  create_table "spotlight_locks", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "on_type"
    t.integer  "on_id"
    t.string   "by_type"
    t.integer  "by_id"
  ...
  create_table "spotlight_main_navigations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "label"
  ...
  create_table "spotlight_pages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "title"
    t.string   "type"
    t.string   "slug"
    t.string   "scope"
  ...
  create_table "spotlight_resources", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "exhibit_id"
    t.string   "type"
    t.string   "url"
  ...
  create_table "spotlight_roles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.string  "role"
  ...
  create_table "spotlight_searches", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "title"
    t.string   "slug"
    t.string   "scope"
  ...
  create_table "spotlight_sites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string  "title"
    t.string  "subtitle"
    t.integer "masthead_id"
  end

  create_table "spotlight_solr_document_sidecars", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "exhibit_id"
